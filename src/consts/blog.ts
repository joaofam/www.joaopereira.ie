...
export const BLOG_FILTERS = ['All', 'Project', 'Tutorials', 'Reviews', 'Web Dev', "IoT", "Server", "Guide"];
...
export const BLOG_ITEMS = [
    {
        ...
        date: "17.12.24",
        tags: ["Guide", "Server"],
        description: "This project sets up a self-hosted server using Traefik and Docker Compose on an old server to run media, storage, and other services. Traefik manages reverse proxying, while Docker Compose orchestrates containers for service management. The setup offers full control over data, providing a private, yet easy to configure infrastructure.",
