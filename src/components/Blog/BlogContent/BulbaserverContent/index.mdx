...
### ARR Stack
<br />
My entire arr stack is managed in a single docker-compose file inside a folder called **media-srv**. 
This allows me to easily manage and update all my services in one place.
<br />
